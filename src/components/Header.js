    ...
    <div className="flex flex-col justify-between bg-gray-600 lg:w-1/3" >
      <div className=" lg:pt-24 lg:mx-20">
        ...
        <div className="text-center space-y-4">
          <p className="text-gray-100 text-4xl font-semibold mt-6">Ngoc Quach</p>
          ...
          <div className="flex justify-center space-x-4 text-3xl">
            ...
            <div>
              <a href="https://github.com/ngocxxu">
                <i className="fab fa-github-square text-white"></i>{" "}
              </a>
            </div>
            <div>
          ...
          <div>
            <button className="text-gray-100 bg-gray-500 border-gray-100 border-2 py-2 px-7 rounded-full hover:bg-white hover:text-blue-500 mt-8">
              <a href="https://www.topcv.vn/xem-cv/DFlWBgQGAw9dDwILVwIFVg4GCQ8MAgIDXFQLUg74ed">Download CV</a>
            </button>
          </div>
        </div>
      </div>
